...
var onGetLocation = function onGetLocation(event) {
  event.preventDefault();
  var data = getFormFields(this);
  api.getLocation(data).then(ui.onGetLocationSuccess).catch(ui.onGetLocationFailure);
};
...
var latitude = __webpack_require__(30);
var longitude = __webpack_require__(31);
...
var onGetLocationSuccess = function onGetLocationSuccess(data) {
  clearHtml();
  var showAddress = address({ results: data.results[0].formatted_address });
  var showLatitude = latitude({ results: data.results[0].geometry.location.lat });
  var showLongitude = longitude({ results: data.results[0].geometry.location.lng });
  $('.locations').append(showAddress);
  $('.geometry').append(showLatitude);
  $('.geometry').append(showLongitude);
};

var onGetLocationFailure = function onGetLocationFailure(data) {
  console.log('Failure');
};

module.exports = {
  onGetLocationSuccess: onGetLocationSuccess,
  onGetLocationFailure: onGetLocationFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<ul class=\"list-group\">\n  <li class=\"list-group-item\">"
    + container.escapeExpression(((helper = (helper = helpers.results || (depth0 != null ? depth0.results : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"results","hash":{},"data":data}) : helper)))
    + "</li>\n</ul>\n";
},"useData":true});
